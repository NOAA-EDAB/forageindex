...
for(dat in predout){
  ...
  fname <- paste0("fhdat/bluepyagg_stn_all_OISST_", dat, ".rds")
  #print(fname)
  ...
  season <- paste0("fall_500_lennosst_ALLsplit_biascorrect_", dat)
  
  working_dir <- here::here(sprintf("pyindex/predsens_%s/", season))
  ...
  season <- paste0("spring_500_lennosst_ALLsplit_biascorrect_", dat)
