...
I can no longer produce the inshore <3 nmi and offshore strata which used a custom extrapolation grid. The current run uses the built in grid and only estimates EPU level indices for the SOE.
...
Trends look comparable. The difference looks loke the time series mean changing with the addition of 2023. So far so good. 
