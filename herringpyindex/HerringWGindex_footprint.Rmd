...
### Piscivore predator list

Not that many. Seems a spring model will run anyway using the forage index configuration but a fall model will not. This is the full time series from the stomach data, we aren't using all of it in the model. 
...
Visual: stations with herring observations across all years by season, 1982-2022
