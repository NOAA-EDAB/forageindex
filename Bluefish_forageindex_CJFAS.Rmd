...
Index trends were not sensitive to OI SST substitution. Despite potential mismatches between in-situ temperature and OI SST in certain locations (Supplement 1, Figs 4 a-e), substituting the OI SST when in-situ survey temperature was missing did not affect the estimated index early in the time series. Index trends estimated with and without SST as a covariate were nearly identical (Supplement 1 Fig.6) and showed no divergence early in the time series where more OI SST information is included.
