...
At this point, filter out NEFSC predators for sensitivities.
...
bluepyall_stn <- fh.nefsc.pisc.pisccomplete.blueprey %>%
  # uncomment to remove a predator for sensitivity
  #filter(pdcomnam != "FOURSPOT FLOUNDER") %>%
  #filter(pdcomnam != "LONGFIN SQUID") %>%
  #filter(pdcomnam != "WHITE HAKE") %>%
...
# uncomment to save alternative predator set
#saveRDS(bluepyall_stn, here("fhdat/bluepyall_stn_no4spot.rds"))
#saveRDS(bluepyall_stn, here("fhdat/bluepyall_stn_nololigo.rds"))
#saveRDS(bluepyall_stn, here("fhdat/bluepyall_stn_nowhake.rds"))
saveRDS(bluepyall_stn, here("fhdat/bluepyall_stn_nospdog.rds"))
...
# uncomment for alternative predator set
#saveRDS(bluepyagg_stn, here("fhdat/bluepyagg_stn_no4spot.rds"))
#saveRDS(bluepyagg_stn, here("fhdat/bluepyagg_stn_nololigo.rds"))
#saveRDS(bluepyagg_stn, here("fhdat/bluepyagg_stn_nowhake.rds"))
saveRDS(bluepyagg_stn, here("fhdat/bluepyagg_stn_nospdog.rds"))
...
neamap_bluepreyagg_stn <- read_csv(here("fhdat/Mean stomach weights_Bluefish Prey_NO SPINY_wWQ2023.csv")) %>%
...
#saveRDS(bluepyagg_stn, here("fhdat/bluepyagg_stn_all_no4spot.rds"))
#saveRDS(bluepyagg_stn, here("fhdat/bluepyagg_stn_all_nololigo.rds"))
#saveRDS(bluepyagg_stn, here("fhdat/bluepyagg_stn_all_nowhake.rds"))
saveRDS(bluepyagg_stn, here("fhdat/bluepyagg_stn_all_nospdog.rds"))
```
...
# uncomment for predator sensitivity
#bluepyagg_stn_all <- readRDS(here("fhdat/bluepyagg_stn_all_no4spot.rds"))
#bluepyagg_stn_all <- readRDS(here("fhdat/bluepyagg_stn_all_nololigo.rds"))
#bluepyagg_stn_all <- readRDS(here("fhdat/bluepyagg_stn_all_nowhake.rds"))
bluepyagg_stn_all <- readRDS(here("fhdat/bluepyagg_stn_all_nospdog.rds"))
...
# uncomment for predator sensitivity
#saveRDS(bluepyagg_stn_all, here("fhdat/bluepyagg_stn_all_no4spot.rds"))
#saveRDS(bluepyagg_stn_all, here("fhdat/bluepyagg_stn_all_nololigo.rds"))
#saveRDS(bluepyagg_stn_all, here("fhdat/bluepyagg_stn_all_nowhake.rds"))
saveRDS(bluepyagg_stn_all, here("fhdat/bluepyagg_stn_all_nospdog.rds"))
```
...
#saveRDS(dietstn_OISST, here("data-raw/dietstn_OISST_no4spot.rds"))
#saveRDS(dietstn_OISST, here("data-raw/dietstn_OISST_nololigo.rds"))
#saveRDS(dietstn_OISST, here("data-raw/dietstn_OISST_nowhake.rds"))
saveRDS(dietstn_OISST, here("data-raw/dietstn_OISST_nospdog.rds"))
...
#bluepyagg_stn_all <- readRDS(here("fhdat/bluepyagg_stn_all_no4spot.rds"))
#dietstn_OISST <- readRDS(here("data-raw/dietstn_OISST_no4spot.rds"))

#bluepyagg_stn_all <- readRDS(here("fhdat/bluepyagg_stn_all_nololigo.rds"))
#dietstn_OISST <- readRDS(here("data-raw/dietstn_OISST_nololigo.rds"))

#bluepyagg_stn_all <- readRDS(here("fhdat/bluepyagg_stn_all_nowhake.rds"))
#dietstn_OISST <- readRDS(here("data-raw/dietstn_OISST_nowhake.rds"))

bluepyagg_stn_all <- readRDS(here("fhdat/bluepyagg_stn_all_nospdog.rds"))
dietstn_OISST <- readRDS(here("data-raw/dietstn_OISST_nospdog.rds"))
...
#saveRDS(bluepyagg_stn_all_OISST, here("fhdat/bluepyagg_stn_all_OISST_no4spot.rds"))
#saveRDS(bluepyagg_stn_all_OISST, here("fhdat/bluepyagg_stn_all_OISST_nololigo.rds"))
#saveRDS(bluepyagg_stn_all_OISST, here("fhdat/bluepyagg_stn_all_OISST_nowhake.rds"))
saveRDS(bluepyagg_stn_all_OISST, here("fhdat/bluepyagg_stn_all_OISST_nospdog.rds"))
