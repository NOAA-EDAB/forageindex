...
```{r trendcomp, fig.cap="Trend comparisons between forage indices estimated with and without SST as a catchability covariate.", fig.show='hold', fig.height=9}
...
```{r scalecomp, fig.cap="Scale comparisons between forage indices estimated with and without SST as a catchability covariate.", fig.show='hold', fig.height=9}
# from each output folder in pyindex, 
