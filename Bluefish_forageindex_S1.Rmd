...
Spatial resolution is visible in sample plots of OISST from March 15 and September 15 2021 (Fig. \@ref(fig:sampleOISST)).

```{r sampleOISST, fig.show='hold', out.width='49%', fig.cap="March 15 2021 and September 15 2021 OISST for the Northeast US Shelf."}
#visualize
...
```{r comparestations, fig.cap="Comparison of NEFSC in situ surface temperature measurments (surftemp) with OISST temperatures (oisst) for the same date and 25 km grid cell. The blue line is a smooth through the data, the black line is the desired 1:1 relationship where temperatures match."}
