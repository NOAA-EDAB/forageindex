...
New_Extrapolation_List <- readRDS(here::here(
  "spatialdat/CustomExtrapolationList.rds"
))

# try this fix to get custom grid to run in updated VAST/FishStatsUtils
New_Extrapolation_List$Area_km2_x = as_units(
  New_Extrapolation_List$Area_km2_x,
  "km2"
)
...
working_dir <- here::here(sprintf("test_SOEpyindex/allagg_%s/", season))
