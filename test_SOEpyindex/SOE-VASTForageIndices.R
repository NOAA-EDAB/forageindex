...
# make data files
SOEinputs(infile = "test_SOEpyindex/allagg_fall_500_lennosst_ALLsplit_biascorrect/Index.csv",
          season = "Fall",
          stratlook = stratlook_ALLsplit,
           outfile = "test_SOEpyindex/fallforageindex.rds")

SOEinputs(infile = "test_SOEpyindex/allagg_spring_500_lennosst_ALLsplit_biascorrect/Index.csv",
          season = "Spring",
          stratlook = stratlook_ALLsplit,
           outfile = "test_SOEpyindex/springforageindex.rds")
