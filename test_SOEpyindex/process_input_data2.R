...
NEAMAPblueprey_csv <- read.csv(here::here(
  "fhdat/Full Prey List_Common Names.csv"
))
...
### QA: compare to original combined data ----
write.csv(
  bluepyagg_stn_all,
...
orig_bluepyagg_stn_all <- read.csv(here::here(
  "test_SOEpyindex",
  "orig_bluepyagg_stn_all.csv"
))
...
orig_dietstn_OISST <- readRDS(here::here(
  "test_SOEpyindex",
  "orig_dietstn_OISST_1982_2023.rds"
))
